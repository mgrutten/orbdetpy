...
plt.savefig('img/prefit-residuals.png')
...
plt.savefig('img/postfit-residuals.png')
...
plt.savefig('img/ric-velocity.png')
...
plt.savefig('img/ric-position.png')
...
if sdim == 9 :
    ...
    plt.savefig('img/ric-acceleration.png')
